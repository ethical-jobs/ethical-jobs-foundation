(function (global, factory) {
	...
	(factory((global['ethical-jobs-foundation'] = global['ethical-jobs-foundation'] || {})));
...
var immutable = createCommonjsModule(function (module, exports) {
  ...
  (function (global, factory) {
    ...
    var ArraySeq = function (IndexedSeq) {
      ...
      ArraySeq.prototype.get = function get$$1(index, notSetValue) {
    ...
    var ObjectSeq = function (KeyedSeq) {
      ...
      ObjectSeq.prototype.get = function get$$1(key, notSetValue) {
    ...
    var ToKeyedSequence = function (KeyedSeq$$1) {
      ...
      ToKeyedSequence.prototype.get = function get$$1(key, notSetValue) {
    ...
    var Map = function (KeyedCollection$$1) {
      ...
      Map.prototype.get = function get$$1(k, notSetValue) {
        return this._root ? this._root.get(0, undefined, k, notSetValue) : notSetValue;
      };

      // @pragma Modification

      Map.prototype.set = function set$$1(k, v) {
    ...
    ArrayMapNode.prototype.get = function get$$1(shift, keyHash, key, notSetValue) {
    ...
    BitmapIndexedNode.prototype.get = function get$$1(shift, keyHash, key, notSetValue) {
    ...
    HashArrayMapNode.prototype.get = function get$$1(shift, keyHash, key, notSetValue) {
      if (keyHash === undefined) {
        keyHash = hash(key);
      }
    ...
    HashCollisionNode.prototype.get = function get$$1(shift, keyHash, key, notSetValue) {
      var entries = this.entries;
      for (var ii = 0, len = entries.length; ii < len; ii++) {
        if (is(key, entries[ii][0])) {
          return entries[ii][1];
    ...
    ValueNode.prototype.get = function get$$1(shift, keyHash, key, notSetValue) {
    ...
    var List = function (IndexedCollection$$1) {
      ...
      List.prototype.get = function get$$1(index, notSetValue) {
        index = wrapIndex(this, index);
      ...
      List.prototype.set = function set$$1(index, value) {
    ...
    var OrderedMap = function (Map$$1) {
      ...
      OrderedMap.prototype.get = function get$$1(k, notSetValue) {
      ...
      OrderedMap.prototype.set = function set$$1(k, v) {
    ...
    var Stack = function (IndexedCollection$$1) {
      ...
      Stack.prototype.get = function get$$1(index, notSetValue) {
        var head = this._head;
        index = wrapIndex(this, index);
        while (head && index--) {
          head = head.next;
    ...
    var Set = function (SetCollection$$1) {
      function Set(value) {
        return value === null || value === undefined ? emptySet() : isSet(value) && !isOrdered(value) ? value : emptySet().withMutations(function (set$$1) {
    ...
    var Range = function (IndexedSeq$$1) {
      ...
      Range.prototype.get = function get$$1(index, notSetValue) {
    ...
    mixin(Collection, {
      ...
      get: function get$$1(searchKey, notSetValue) {
    ...
    mixin(IndexedCollection, {
      ...
      get: function get$$1(index, notSetValue) {
        index = wrapIndex(this, index);
    ...
    mixin(SetCollection, {
      ...
      get: function get$$1(value, notSetValue) {
    ...
    var OrderedSet = function (Set$$1) {
      function OrderedSet(value) {
        return value === null || value === undefined ? emptyOrderedSet() : isOrderedSet(value) ? value : emptyOrderedSet().withMutations(function (set$$1) {
    ...
    Record.prototype.get = function get$$1(k, notSetValue) {
      if (!this.has(k)) {
        return notSetValue;
      }
    ...
    Record.prototype.set = function set$$1(k, v) {
      if (this.has(k)) {
    ...
    var Repeat = function (IndexedSeq$$1) {
      ...
      Repeat.prototype.get = function get$$1(index, notSetValue) {
...
var roles = [{ name: 'service-account', description: 'Service account' }, { name: 'admin', description: 'Administrator' }, { name: 'staff-member', description: 'Staff Member' }, { name: 'relations-team', description: 'Relationships Team' }, { name: 'customer-service-team', description: 'Customer Service Team' }, { name: 'employer-member', description: 'Employer user' }, { name: 'job-seeker', description: 'Job seeker' }];
...
//# sourceMappingURL=ethical-jobs-foundation.js.map
